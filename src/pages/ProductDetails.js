...
const ProductDetails = () => {
  ...
  if(!product){
    return <section className='h-screen flex justify-center items-center'> </section>
  }
  ...
  return(
    <section className='pt-32 pb-12 lg:py-32 h-screen flex items-cebter'>
    <div className='container mx-auto'>
       ...
       <div className='flex flex-col justify-center items-center mb-8 lg:mb-0'>
        ...
        <div className='flex-1 text-center lg:text-left'>
          <h2 className='text-[26px] font-medium mb-2 max-w-[450px] mx-auto'>{title}</h2>
